...
components: sources: kubernetes_logs: {
		...
		annotation_fields: {
			...
			type: object: {
				...
				options: {
					...
					pod_ip: {
						common: false
						description: "Event field for Pod IP."
						required: false
						type: string: {
					...
					pod_ips: {
						common: false
						description: "Event field for IPv4 and IPv6 Pod IPs."
						required: false
						type: string: {
	...
	output: logs: line: {
		...
		fields: {
			...
			"kubernetes.pod_ip": {
				description: "Pod labels IP address."
				required:    false
				common:      true
				type: string: {
			...
			"kubernetes.pod_ips": {
				description: "Pod labels IPv4 and IPv6 addresses."
				required:    false
				common:      true
				type: string: {
